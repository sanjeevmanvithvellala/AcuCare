...
config = load_config() 
app = FastAPI( title=config["project"]["name"], version=config["project"]["version"], description="A production-ready platform that predicts 30-day hospital readmission risk using explainable AI (SHAP & LIME) and LLM-powered clinical interpretation.", lifespan=lifespan ) 
